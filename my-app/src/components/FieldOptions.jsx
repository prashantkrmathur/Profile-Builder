    ...
    <div className='settings'>
      <h2>Options</h2>     
        ...
        <div className="bio-element">
          ...
          <button className="restoration" onClick={handleRandomReason}>Restoration</button>
        <button className="plan-of-salvation" onClick={handleRandomReason}>Plan of Salvation</button>
        <button className="gospel-of-christ" onClick={handleRandomReason}>Gospel of Christ</button>
        <button className="law-of-chastity" onClick={handleRandomReason}>Law of Chastity</button>
        <button className="word-of-wisdom" onClick={handleRandomReason}>Word of Wisdom</button>
